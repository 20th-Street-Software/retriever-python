...
class MemoryResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> MemoryResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/retriever-python#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> MemoryResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/retriever-python#with_streaming_response
        """
